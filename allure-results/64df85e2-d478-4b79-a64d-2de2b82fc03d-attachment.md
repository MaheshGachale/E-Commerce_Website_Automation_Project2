...
Locator: getByRole('link', { name: 'Welcome user_sg9bg3an' })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByRole('link', { name: 'Welcome user_sg9bg3an' })
...
- dialog "Log in":
  - document:
    ...
    - button "Close"
    - text: "Username:"
    - textbox: user_sg9bg3an
    - text: "Password:"
    - textbox: pass_6kjif5v8
    - button "Close"
    - button "Log in"
- navigation:
  - link "PRODUCT STORE":
...
```ts
   ...
   17 |   page.once('dialog', dialog => dialog.dismiss().catch(() => {}));
   18 | });
   19 |

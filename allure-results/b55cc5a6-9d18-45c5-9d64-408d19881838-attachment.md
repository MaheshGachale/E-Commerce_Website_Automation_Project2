...
Locator: getByRole('link', { name: 'Welcome user_ix0fb6bs' })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByRole('link', { name: 'Welcome user_ix0fb6bs' })

    at C:\Users\Mahesh Gachale\Desktop\Advanced_Projects\E-Commerce Website Automation\tests\Automation.spec.js:29:73
```
...
- dialog "Log in":
  - document:
    ...
    - button "Close"
    - text: "Username:"
    - textbox: user_ix0fb6bs
    - text: "Password:"
    - textbox: pass_o9lculez
    - button "Close"
    - button "Log in"
- navigation:
  - link "PRODUCT STORE":

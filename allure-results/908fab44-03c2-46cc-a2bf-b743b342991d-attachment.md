...
- Location: C:\Users\Mahesh Gachale\Desktop\Advanced_Projects\E-Commerce Website Automation\tests\Automation.spec.js:36:5
...
Call log:
  - waiting for getByRole('link', { name: 'Add to cart' })
    ...
    at ProductPage.addToCart (C:\Users\Mahesh Gachale\Desktop\Advanced_Projects\E-Commerce Website Automation\pages\ProductPage.js:9:32)
    at C:\Users\Mahesh Gachale\Desktop\Advanced_Projects\E-Commerce Website Automation\tests\Automation.spec.js:53:21
```
...
```ts
   ...
   2 |   constructor(page) {
   3 |     this.page = page;
   4 |     this.addToCartButton = page.getByRole('link', { name: 'Add to cart' });
   5 |   }
   6 |
   7 |   async addToCart() {
   8 |     this.page.once('dialog', dialog => dialog.dismiss().catch(() => {})); // Use this.page
>  9 |     await this.addToCartButton.click();
     |                                ^ Error: locator.click: Test timeout of 30000ms exceeded.
  10 |   }
  11 | }
  12 |
  13 | export default ProductPage;
  14 |
```